        ...
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            if (!Emergency)
            {
                ...
                if (StartPos != null && EndPos != null)
                {
                    ...
                    Pathfinding.AStarAlgorithm(data.ComplexPath[StartPos], data.ComplexPath[EndPos]);

                    long endMemory = GC.GetTotalMemory(true);
                    Console.WriteLine($"1x memory used: {endMemory - startMemory} bytes");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"1x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"5x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"10x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"20x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"50x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"100x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"200x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"500x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"1000x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"2000x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"5000x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");
                    ...
                    stopwatch.Stop();
                    Console.WriteLine($"10000x Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");                   
